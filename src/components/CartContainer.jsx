    ...
    <div className="fixed top-0 right-0 w-full md:w-375 h-screen bg-white drop-shadow-md flex flex-col z-[101]">
      ...
      <div className="w-full h-full bg-cartBg rounded-t-[2rem] flex flex-col">
        ...
        <div className="w-full h-340 md:h-42 px-6 py-10 flex flex-col gap-3 overflow-y-scroll scrollbar-none">
          {/* cart Item */}
          <div className="w-full p-1 px-1 rounded-lg bg-cartItem flex items-center gap-2">
            <img
              src="https://firebasestorage.googleapis.com/v0/b/react-app-91087.appspot.com/o/Images%2F1682118030343-gc-02.jpg?alt=media&token=1d1b50cc-96f9-4c07-b4f1-b794db023055"
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="text-sm block text-gray-300 font-semibold">$4.4</p>
            </div>
